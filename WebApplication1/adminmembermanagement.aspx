...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div class="container-fluid" style="margin-top: 00px; padding-top: 130px;">
            <div class="row">
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                           ...
                           <div class="row">                                 
                             ...
                             <div class="row">
                                <div class="col-8 mx-auto">
                                    <asp:Button ID="Button2" class="btn btn-block btn-lg btn-danger" runat="server" Text="Delete User Permanently" OnClick="Button2_Click" />
                                </div>                                                   
                            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:kspDBConnectionString %>" SelectCommand="SELECT * FROM [member_master_tbl]"></asp:SqlDataSource>
                    <div class="col">
