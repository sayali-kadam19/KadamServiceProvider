...
{
    public partial class adminPackageissuing : System.Web.UI.Page
    {
        ...
        void issuePackage()
        {
            ...
            {            
                ...
                cmd.Parameters.AddWithValue("@package_name", TextBox4.Text.Trim());
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Package Issued successfully');</script>");
                GridView1.DataBind();
            }
            catch (Exception ex)
            {
        ...
        private void BindGridViewForMember()
        {
            try
            {
                ...
                if (Session["username"] != null)
                {
                    ...
                    SqlDataSource1.SelectCommand = "SELECT * FROM package_issue_tbl WHERE member_id = @memberId";
                    SqlDataSource1.SelectParameters.Clear();
                    SqlDataSource1.SelectParameters.Add("memberId", memberId);
