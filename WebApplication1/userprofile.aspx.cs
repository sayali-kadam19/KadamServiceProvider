    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@state", DropDownList.SelectedItem.Value);
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                DropDownList.SelectedValue = dt.Rows[0]["state"].ToString();
        ...
        void getUserPackageData()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from package_issue_tbl where member_id='" + Session["username"].ToString() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
