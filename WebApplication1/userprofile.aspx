...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                  ...
                  <div class="row">
                     ...
                     <div class="row">
                        <div class="col-8 mx-auto">
                            <center>
                            <div class="form-group">
                                <asp:Button class="btn btn-primary btn-block btn-lg" ID="Button1" runat="server" Text="Update" OnClick="Button1_Click"></asp:Button>
                            </div>  
                            </center>
                        </div>
                    </div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">
                <center>
                    <img width="100px" src="imgs/wifi.png" />
                </center>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <center>
                    <h4>Current Package</h4>
                        ...
                        <asp:Label Class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Payment due"></asp:Label>
                </center>
            </div>
        </div>
